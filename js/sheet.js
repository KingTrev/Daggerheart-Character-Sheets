...
function renderS0Step(id) {
  ...
  switch(id) {
    ...
    case 'how-hope': return s0Section('Hope, Fear & The GM', `
      ...
      ${s0Card('EXPERIENCES', `<p style="font-size:13px;line-height:1.7;">Experiences are things your character is especially good at — broad enough to apply often, like <em>"Sailor"</em>, <em>"Scholar of the Arcane"</em>, or <em>"Former Soldier"</em>. When a roll fits, spend 1 Hope to add the Experience's bonus (+1, +2, or +3) to your total.</p>`, 'var(--teal)')}
    `);
...
function newCharViaS0() {
  ...
  localStorage.removeItem('dh2-last-class');
  document.getElementById('class-picker').value = '';
  // Wipe S0 data so it starts fresh from step 1
  s0Data = {};
  s0Step = 0;
