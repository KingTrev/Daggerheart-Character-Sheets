...
function showSheetTab(tab) {
  ...
  // Tab bar buttons
  document.getElementById('tab-sheet-btn').classList.toggle('active', tab === 'sheet');
  ...
  document.getElementById('tab-ref-btn').classList.toggle('active', tab === 'ref');
  document.getElementById('tab-s0-btn').classList.toggle('active', tab === 's0');
  // Left nav items
